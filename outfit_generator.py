...
foot_model_path   = "foot_base_model.pkl"

with open(sub_model_path, 'rb') as file:
    sup_model = pickle.load(file)

with open(top_model_path, 'rb') as file:
    top_model = pickle.load(file)

with open(bottom_model_path, 'rb') as file:
    bottom_model= pickle.load(file)

with open(foot_model_path, 'rb') as file:
    foot_model = pickle.load(file)
...
def single_classification(single_path):
    ...
    print("Result from the first model:", result2)
    print("Result from the sub-model:", res)
    print("Result from the sub-model:", res_str)
